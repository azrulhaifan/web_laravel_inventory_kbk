...
<head>
    ...
    <title>PT. KBK Inventory System</title>
...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <img id="background" class="absolute -left-20 top-0 max-w-[877px]" src="{{url('image/background.svg')}}" alt="Laravel background" />
        <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        <a
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Open Inventory App</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    The inventory system for PT Kaina Berkah Karya (KBK) is a specialized solution to streamline and optimize stock management. As an MSME selling toddler apparel and accessories, PT KBK needs an efficient system to track inventory, manage stock, and ensure smooth operations. Tailored to the company’s needs, it improves accuracy, reduces manual workload, and enhances efficiency.
                                </p>
                            </div>
                        ...
                        <a
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Visit SNN Site</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Sukhada Niva Nusantara (SNN) is a micro, small, and medium enterprise (MSME) specializing in software services. Committed to innovation and quality, SNN provides tailored digital solutions to meet the diverse needs of businesses. With a focus on efficiency and cutting-edge technology, the company strives to support digital transformation and enhance business operations through its software expertise.
                                </p>
                            </div>
                ...
                <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                    PT Kaina Berkah Karya Inventory System V0.1 built on (PHP v{{ PHP_VERSION }}) with Laravel 11
                </footer>
            </div>
        </div>
    </div>
